...
def af_test():
    ...
    additional_info = algorithm_instance.additional_anonymization_info
    for info_value in additional_info.itervalues():
    ...
    create_report = raw_input("\nCrear reporte? [Y/n]: ")
    if create_report.lower() != "n":
