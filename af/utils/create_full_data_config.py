...
# TRANSFORMATION TECHNIQUES FOR EACH QI AND IDENTIFIABLE ATTRIBUTES
tt_ssn = TransformationTechnique('supression', ssn_hierarchy)
tt_race = TransformationTechnique('generalization', race_hierarchy)
tt_gender = TransformationTechnique('generalization', gender_hierarchy)
tt_zip = TransformationTechnique('generalization', zip_hierarchy)
tt_year_of_birth = TransformationTechnique('generalization', year_of_birth_hierarchy)
...
att_race.transformation_technique = tt_race

att_gender = Attribute('gender', privacy_type=utils.PRIVACY_TYPE_QI)
att_gender.transformation_technique = tt_gender

att_zip = Attribute('zip', privacy_type=utils.PRIVACY_TYPE_QI)
att_zip.transformation_technique = tt_zip

att_year_of_birth = Attribute('year_of_birth', privacy_type=utils.PRIVACY_TYPE_QI)
att_year_of_birth.transformation_technique = tt_year_of_birth
